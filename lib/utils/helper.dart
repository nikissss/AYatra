...
class Helper {
  static String localize(BuildContext context, String textId) {
    return textId; // Just return the textId directly without localization
  }
  ...
  static String getDateText(DateText dateText, BuildContext context) {
    return "0${dateText.startDate} ${DateFormat('MMM').format(DateTime.now())} - 0${dateText.endDate} ${DateFormat('MMM').format(DateTime.now().add(Duration(days: 2)))}";
  }

  static String getLastSearchDate(DateText dateText, BuildContext context) {
    return "${dateText.startDate} - ${dateText.endDate} ${DateFormat('MMM').format(DateTime.now().add(Duration(days: 2)))}";
  }

  static String getPeopleandChildren(RoomData roomData, BuildContext context) {
    return "${localize(context, "sleeps")} ${roomData.numberOfPeople} ${localize(context, "people")} + ${roomData.numberOfRooms} ${localize(context, "children")} ";
  }
