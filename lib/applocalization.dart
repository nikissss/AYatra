...
// import 'package:yatra1/widgets/common.dart' as common;
...
//   //, Locale localeOf, [Locale localeOf], [Locale localeOf], Locale localeOf, Locale localeOf, Locale localeOf, Locale localeOf call this method only firstTime when open app You can see splash_screen.dart
...
//   AppLocalizations(this.context, this.locale);
...
//       _AppLocalizationsDelegate(context);
// }
...
//   _AppLocalizationsDelegate(this.context);
...
//  @override
//   Future<AppLocalizations> load(Locale locale) async {
//     AppLocalizations localization = AppLocalizations(context, locale);
//     await localization.load();
//     return localization;
//   }
...
//   static LocalizationsDelegate<AppLocalizations> delegate(BuildContext context,Locale locale) {
//     return _AppLocalizationsDelegate(context,locale);
//   }
// }
...
//   _AppLocalizationsDelegate(this.context,this.locale);
...
class AppLocalizations {
 ...
 static LocalizationsDelegate<AppLocalizations> delegate(BuildContext context) {
    return _AppLocalizationsDelegate(context);
  }
}
