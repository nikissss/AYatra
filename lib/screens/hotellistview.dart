...
//                                   ),
//                                   Expanded(child:Text('${hotelData!.dist.toStringAsFixed(1)} km to city',
...
//                                     child:Row(
//                                       children:<Widget>[
//                                         // RatingBar(ratingWidget: RatingWidget(full:Icon(Icons.star_rate_rounded,
//                                         // color:HotelTheme.buildLightTheme().primaryColor,
//                                         // ),half:Icon(Icons.star_half_rounded,
//                                         // color:HotelTheme.buildLightTheme().primaryColor,
//                                         // ),empyt:Icon(Icons.star_border_rounded,
//                                         // color:HotelTheme.buildLightTheme().primaryColor,
//                                         // ),
...
//                                         Text('${hotelData!.reviews} Reviews',
